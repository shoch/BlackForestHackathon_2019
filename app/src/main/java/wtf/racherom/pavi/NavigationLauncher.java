...
public class NavigationLauncher extends com.mapbox.services.android.navigation.ui.v5.NavigationLauncher {
    ...
    public static void startNavigation(Activity activity, NavigationLauncherOptions options) {
        ...
        Intent navigationActivity = new Intent(activity, wtf.racherom.pavi.MapboxNavigationActivity.class);
